...
- Name: BlueDrop Chatbot Test Suite >> 💬 Chatbot Screen >> TC_02: 🧠 Initial chatbot message is displayed
- Location: D:\Automation\Playwright\Bluedrop_academy\tests\Chatbot.spec.ts:64:9
...
Call log:
  - waiting for locator('iframe[name="htmlComp-iframe"]').contentFrame().locator('.system-message-text').first()
    ...
    at D:\Automation\Playwright\Bluedrop_academy\tests\Chatbot.spec.ts:65:7
```
