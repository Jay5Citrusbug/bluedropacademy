...
- Name: BlueDrop Chatbot Test Suite >> 💬 Chatbot Screen >> TC_09: 👍 Like button functionality
- Location: D:\Playwright\Bluedrop_academy\tests\Chatbot.spec.ts:82:9
...
Call log:
  ...
  - waiting for locator('iframe[name="htmlComp-iframe"]').contentFrame().getByRole('heading', { name: 'תכירו את "בלו"' })
    ...
    at D:\Playwright\Bluedrop_academy\tests\Chatbot.spec.ts:37:5
```
