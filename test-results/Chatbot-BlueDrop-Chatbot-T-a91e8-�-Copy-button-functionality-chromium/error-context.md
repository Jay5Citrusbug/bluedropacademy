...
- Name: BlueDrop Chatbot Test Suite >> 💬 Chatbot Screen >> TC_09: 📋 Copy button functionality
- Location: D:\Automation\Playwright\Bluedrop_academy\tests\Chatbot.spec.ts:103:9
...
Locator: locator('iframe[name="htmlComp-iframe"]').contentFrame().locator('[data-testid="copy-response"]')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('iframe[name="htmlComp-iframe"]').contentFrame().locator('[data-testid="copy-response"]')

    at chatbotPage.CopyBtn (D:\Automation\Playwright\Bluedrop_academy\tests\Pages\chatbotPage.ts:281:64)
    at D:\Automation\Playwright\Bluedrop_academy\tests\Chatbot.spec.ts:104:27
```
