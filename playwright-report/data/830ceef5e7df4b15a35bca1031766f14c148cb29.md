...
- Name: BlueDrop Hamburgermenu Test Suite >> Hamburger Menu & 📜 Chat History >> TC_19 ❌ No result in chat history
- Location: D:\Playwright\Bluedrop_academy\tests\Hamburger_Menu.spec.ts:63:9
...
Call log:
  - waiting for locator('iframe[name="htmlComp-iframe"]').contentFrame().locator('input[placeholder="חפש"]')
    ...
    at HamburgerMenuPage.NoSearchHistory (D:\Playwright\Bluedrop_academy\tests\Pages\HamburgerMenuPage.ts:59:55)
    at D:\Playwright\Bluedrop_academy\tests\Hamburger_Menu.spec.ts:65:18
```
