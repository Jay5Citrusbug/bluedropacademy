...
- Name: BlueDrop Hamburgermenu Test Suite >> Hamburger Menu & 📜 Chat History >> TC_18 ❎ Close Hamburger Menu
- Location: D:\Automation\Playwright\Bluedrop_academy\tests\Hamburger_Menu.spec.ts:115:9
...
Call log:
  ...
  - waiting for locator('iframe[name="htmlComp-iframe"]').contentFrame().getByRole('button', { name: 'Close' })
    ...
    at HamburgerMenuPage.CloseHamburgerMenu (D:\Automation\Playwright\Bluedrop_academy\tests\Pages\HamburgerMenuPage.ts:98:71)
    at D:\Automation\Playwright\Bluedrop_academy\tests\Hamburger_Menu.spec.ts:117:7
```
