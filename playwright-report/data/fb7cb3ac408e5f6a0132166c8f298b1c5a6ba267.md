...
- Location: D:\Playwright\Bluedrop_academy\tests\Hamburger_Menu.spec.ts:58:9
...
Call log:
  ...
  - waiting for locator('iframe[name="htmlComp-iframe"]').contentFrame().locator('input[placeholder="חפש"]')
    ...
    at HamburgerMenuPage.SearchHistory (D:\Playwright\Bluedrop_academy\tests\Pages\HamburgerMenuPage.ts:48:25)
    at D:\Playwright\Bluedrop_academy\tests\Hamburger_Menu.spec.ts:60:18
```
