...
- Name: BlueDrop Chatbot Test Suite >> 💬 Chatbot Screen >> TC_14: ⏱️ Session pop-up displays after 10 minutes and close pop-up
- Location: D:\Automation\Playwright\Bluedrop_academy\tests\Chatbot.spec.ts:136:7
...
Expected substring: "Tom"
Received string:    "הי Eduardo,
יש לי תחושה שהיום נגלה דברים מעניינים יחד! במה נתחיל? 🤔🔎
כל רעיון, שאלה או מחשבה – אני כאן בשביל זה."
    at chatbotPage.InitialbotMessage (D:\Automation\Playwright\Bluedrop_academy\tests\Pages\chatbotPage.ts:38:23)
    at D:\Automation\Playwright\Bluedrop_academy\tests\Chatbot.spec.ts:141:5
```
