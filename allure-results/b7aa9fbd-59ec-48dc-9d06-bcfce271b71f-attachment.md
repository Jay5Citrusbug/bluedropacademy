...
Call log:
  - waiting for locator('//html/body/div[2]/div/div[3]/div/div[2]/div/div/ul/li[2]/button')
    ...
    at chatbotPage.OpenHamburgerMenu (D:\Playwright\Bluedrop_academy\tests\Pages\chatbotPage.ts:135:97)
...
> 135 |     await this.page.locator('//html/body/div[2]/div/div[3]/div/div[2]/div/div/ul/li[2]/button').click({force: true});
      |                                                                                                 ^ Error: locator.click: Target page, context or browser has been closed
