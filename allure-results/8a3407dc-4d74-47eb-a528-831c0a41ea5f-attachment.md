...
- Location: D:\Playwright\Bluedrop_academy\tests\Hamburger_Menu.spec.ts:45:9

# Error details

```
Error: expect.toBeVisible: Unexpected token "" while parsing css selector "[hamburger-click"]". Did you mean to CSS.escape it?
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for iframe[name="htmlComp-iframe"] >> internal:control=enter-frame >> [hamburger-click"]

    at chatbotPage.OpenHamburgerMenu (D:\Playwright\Bluedrop_academy\tests\Pages\chatbotPage.ts:131:30)
    at D:\Playwright\Bluedrop_academy\tests\Hamburger_Menu.spec.ts:46:27
```
...
```ts
  ...
  128 |     const menuButton = frameLocator.locator(Chatbotlocator.hamburgerMenuBtn);
  129 |
