...
- Name: BlueDrop test cases >> Hamburger Menu & History >> TC_15: Load More button functionality
- Location: D:\Playwright\Bluedrop_academy\tests\Main.spec.ts:115:9
...
Call log:
  - waiting for locator('iframe[name="htmlComp-iframe"]').contentFrame().locator('button[data-testid="load-more-click"]')
    ...
    at chatbotPage.LoadmoreBtn (D:\Playwright\Bluedrop_academy\tests\Pages\chatbotPage.ts:169:58)
    at D:\Playwright\Bluedrop_academy\tests\Main.spec.ts:116:7
```
