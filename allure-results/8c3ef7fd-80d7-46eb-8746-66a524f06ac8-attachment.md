...
Locator: locator('iframe[name="htmlComp-iframe"]').contentFrame().locator('button[data-testid="load-more-click"]')
Expected: visible
...
Call log:
  ...
  - waiting for locator('iframe[name="htmlComp-iframe"]').contentFrame().locator('button[data-testid="load-more-click"]')
    ...
    at chatbotPage.LoadmoreBtn (D:\Playwright\Bluedrop_academy\tests\Pages\chatbotPage.ts:142:68)
    at D:\Playwright\Bluedrop_academy\tests\Hamburger_Menu.spec.ts:50:27
```
