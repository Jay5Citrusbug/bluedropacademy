...
- Name: BlueDrop test cases >> TC_08: Submit query
- Location: D:\Playwright\Bluedrop_academy\tests\Edge_case.spec.ts:60:9
...
Call log:
  ...
  - waiting for locator('iframe[name="htmlComp-iframe"]').contentFrame().locator('button[data-testid="send-message-button"]')
    ...
    at D:\Playwright\Bluedrop_academy\tests\Edge_case.spec.ts:61:27
```
