...
- Name: BlueDrop test cases >> Hamburger Menu & History >> TC_18: Search in chat history
- Location: D:\Playwright\Bluedrop_academy\tests\Hamburger_Menu.spec.ts:53:9
...
Call log:
  ...
  - waiting for locator('iframe[name="htmlComp-iframe"]').contentFrame().locator('input[placeholder="חפש"]')
    ...
    at chatbotPage.SearchHistory (D:\Playwright\Bluedrop_academy\tests\Pages\chatbotPage.ts:151:25)
    at D:\Playwright\Bluedrop_academy\tests\Hamburger_Menu.spec.ts:54:27
```
