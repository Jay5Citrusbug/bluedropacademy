...
- Location: D:\Playwright\Bluedrop_academy\tests\Main.spec.ts:68:9
...
Call log:
  - waiting for locator('iframe[name="htmlComp-iframe"]').contentFrame().getByTestId('seach-msg-input')
    ...
    at chatbotPage.SubmitbtnActive (D:\Playwright\Bluedrop_academy\tests\Pages\chatbotPage.ts:47:55)
    at D:\Playwright\Bluedrop_academy\tests\Main.spec.ts:69:27
```
