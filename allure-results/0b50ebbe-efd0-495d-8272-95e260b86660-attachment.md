...
- Name: BlueDrop test cases >> Hamburger Menu & History >> TC_17: New session with "שיחה חדשה"
...
Call log:
  - waiting for locator('iframe[name="htmlComp-iframe"]').contentFrame().getByRole('button', { name: 'icon' }).nth(2)
    ...
    at chatbotPage.Newsession (D:\Playwright\Bluedrop_academy\tests\Pages\chatbotPage.ts:191:35)
