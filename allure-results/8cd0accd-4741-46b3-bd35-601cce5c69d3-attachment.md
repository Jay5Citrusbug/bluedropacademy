...
- Name: BlueDrop test cases >> Hamburger Menu & History >> TC_16: Search in chat history
- Location: D:\Playwright\Bluedrop_academy\tests\Main.spec.ts:119:9
...
Call log:
  ...
  - waiting for locator('iframe[name="htmlComp-iframe"]').contentFrame().locator('input[placeholder="חפש"]')
    ...
    at chatbotPage.SearchHistory (D:\Playwright\Bluedrop_academy\tests\Pages\chatbotPage.ts:181:21)
    at D:\Playwright\Bluedrop_academy\tests\Main.spec.ts:120:7
```
