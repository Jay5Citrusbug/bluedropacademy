...
```
Error: locator.isVisible: Unexpected token "/" while parsing css selector "/html/body/div[2]/div/div[3]/div/div[2]/div/div/ul/li[2]/div". Did you mean to CSS.escape it?
Call log:
    - checking visibility of /html/body/div[2]/div/div[3]/div/div[2]/div/div/ul/li[2]/div

    at chatbotPage.OpenHamburgerMenu (D:\Playwright\Bluedrop_academy\tests\Pages\chatbotPage.ts:134:93)
...
```ts
  ...
  133 |
> 134 |     await this.page.locator('/html/body/div[2]/div/div[3]/div/div[2]/div/div/ul/li[2]/div').isVisible();
      |                                                                                             ^ Error: locator.isVisible: Unexpected token "/" while parsing css selector "/html/body/div[2]/div/div[3]/div/div[2]/div/div/ul/li[2]/div". Did you mean to CSS.escape it?
  135 |     await this.page.locator('/html/body/div[2]/div/div[3]/div/div[2]/div/div/ul/li[2]/div').click();
