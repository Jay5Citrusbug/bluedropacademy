...
Call log:
  - waiting for locator('iframe[name="htmlComp-iframe"]').contentFrame().locator('button[data-testid="hamburger-click"]')
  ...
  - attempting click action
    ...
    at chatbotPage.OpenHamburgerMenu (D:\Playwright\Bluedrop_academy\tests\Pages\chatbotPage.ts:132:22)
    at D:\Playwright\Bluedrop_academy\tests\Hamburger_Menu.spec.ts:46:7
```
