...
- Name: BlueDrop test cases >> Chatbot Screen >> TC_14: Reload hides old chat
- Location: D:\Playwright\Bluedrop_academy\tests\Main.spec.ts:99:9
...
Call log:
  ...
  - waiting for locator('iframe[name="htmlComp-iframe"]').contentFrame().getByRole('heading', { name: 'תכירו את "בלו"' })
    ...
    at D:\Playwright\Bluedrop_academy\tests\Main.spec.ts:34:7
```
