...
- Name: BlueDrop test cases >> Chatbot Screen >> TC_12: Dislike buttons
...
Locator: locator('iframe[name="htmlComp-iframe"]').contentFrame().locator('[data-testid="dislike-thumb"]')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('iframe[name="htmlComp-iframe"]').contentFrame().locator('[data-testid="dislike-thumb"]')

    at chatbotPage.DisLikeBtn (D:\Playwright\Bluedrop_academy\tests\Pages\chatbotPage.ts:208:67)
    at D:\Playwright\Bluedrop_academy\tests\Main.spec.ts:90:26
```
