...
- Name: BlueDrop test cases >> Chatbot Screen >> TC_09: Scroll to bottom
- Location: D:\Playwright\Bluedrop_academy\tests\Main.spec.ts:78:9
...
Call log:
  - waiting for locator('iframe[name="htmlComp-iframe"]').contentFrame().locator('//*[@id="root"]/div/div[2]/main/div/div/div[2]/div[1]/button/img')
    ...
    at D:\Playwright\Bluedrop_academy\tests\Main.spec.ts:79:7
```
