...
Call log:
  - navigating to "https://bluedropacademy.wixsite.com/website-1/chat6?rc=test-site", waiting until "load"

    at ChatbotLoginPage.goto (D:\Playwright\Bluedrop_academy\tests\Pages\LoginChatbot.ts:16:21)
    at D:\Playwright\Bluedrop_academy\tests\Hamburger_Menu.spec.ts:33:21
```
