...
- Name: BlueDrop test cases >> Hamburger Menu & History >> TC_15: No result in chat history
...
Call log:
  - waiting for locator('iframe[name="htmlComp-iframe"]').contentFrame().locator('input[placeholder="חפש"]')
    ...
    at chatbotPage.NoSearchHistory (D:\Playwright\Bluedrop_academy\tests\Pages\chatbotPage.ts:176:60)
    at D:\Playwright\Bluedrop_academy\tests\Main.spec.ts:114:27
```
