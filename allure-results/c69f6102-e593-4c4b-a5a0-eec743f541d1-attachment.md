...
- Name: BlueDrop test cases >> Hamburger Menu & History >> TC_17: No result in chat history
- Location: D:\Playwright\Bluedrop_academy\tests\Main.spec.ts:123:9
...
Call log:
  - waiting for locator('iframe[name="htmlComp-iframe"]').contentFrame().locator('input[placeholder="חפש"]')
    ...
    at chatbotPage.NoSearchHistory (D:\Playwright\Bluedrop_academy\tests\Pages\chatbotPage.ts:190:60)
    at D:\Playwright\Bluedrop_academy\tests\Main.spec.ts:124:27
```
