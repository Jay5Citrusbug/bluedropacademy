...
- Location: D:\Playwright\Bluedrop_academy\tests\Main.spec.ts:48:9
...
Call log:
  - waiting for getByRole('button', { name: 'התחברות עם כתובת מייל' })
    ...
    at ChatbotLoginPage.login (D:\Playwright\Bluedrop_academy\tests\Pages\LoginChatbot.ts:20:93)
    at D:\Playwright\Bluedrop_academy\tests\Main.spec.ts:36:19
```
