...
- Name: BlueDrop test cases >> Hamburger Menu & History >> TC_19: No result in chat history
- Location: D:\Playwright\Bluedrop_academy\tests\Hamburger_Menu.spec.ts:57:9
...
Call log:
  - waiting for locator('iframe[name="htmlComp-iframe"]').contentFrame().locator('input[placeholder="חפש"]')
    ...
    at chatbotPage.NoSearchHistory (D:\Playwright\Bluedrop_academy\tests\Pages\chatbotPage.ts:161:58)
    at D:\Playwright\Bluedrop_academy\tests\Hamburger_Menu.spec.ts:58:27
```
