...
- Location: D:\Playwright\Bluedrop_academy\tests\Main.spec.ts:116:9
...
Locator: locator('iframe[name="htmlComp-iframe"]').contentFrame().getByRole('button', { name: 'icon' }).nth(2)
Expected: visible
...
Call log:
  ...
  - waiting for locator('iframe[name="htmlComp-iframe"]').contentFrame().getByRole('button', { name: 'icon' }).nth(2)
    ...
    at D:\Playwright\Bluedrop_academy\tests\Main.spec.ts:117:27
```
